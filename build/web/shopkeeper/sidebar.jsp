      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="addProducts.jsp">Add Product</a>
            <a class="collapse-item" href="viewProduct.jsp">View Product</a>
            <a class="collapse-item" href="statusProduct.jsp">Update Status</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Pending Products</a>
            <a class="collapse-item" href="#">Approved Products</a>
            <a class="collapse-item" href="#">Rejected Products</a>
          </div>
        </div>
      </li>
