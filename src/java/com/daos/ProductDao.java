...
public class ProductDao {
    ...
    public boolean addProduct(Product product, int weartype_id, int cat_id) {
        ...
        if (con != null) {
            try {
                ...
                String sql = "insert into product(name,price,size,color,brand,image,description,stock,selling_price) values(?,?,?,?,?,?,?,?,?)";
                ...
                if (rs.next()) {
                    ...
                    smt = con.prepareStatement("insert into product_r (product_id,weartype_id,cat_id) values(?,?,?)");
                    smt.setInt(1, p_id);
    ...
    public ArrayList<Product> getAllProductByWearType(int wear_id) {
        ...
        try {
            ...
            Connection con = cp.getConnection();
            if (con != null) {
                String sql = "select * from product where id in(select product_id from product_r where weartype_id in(select id from wear_type where id=?))";
                PreparedStatement smt = con.prepareStatement(sql);
    ...
    public ArrayList<Product> getAllProductByCategory(String category) {
        ...
        try {
            ...
            Connection con = cp.getConnection();
            if (con != null) {
                String sql = "select * from product where id in(select product_id from product_r where cat_id in(select id from category where name=?))";
                PreparedStatement smt = con.prepareStatement(sql);
    ...
    public ArrayList<Product> getAllProductByWearTypeIdAndCategoryId(int wear_id, int cat_id) {
        ...
        try {
            ...
            Connection con = cp.getConnection();
            if (con != null) {
                String sql = "select * from product where id in(select product_id from product_r where cat_id in(select id from category where id=?)and weartype_id in(select id from wear_type where id=?))";
                PreparedStatement smt = con.prepareStatement(sql);
                smt.setInt(1, cat_id);
    ...
    public ArrayList<Product> getAllProductByWearTypeAndCategoryAndColor(String weartype, String category, String color) {
        ...
        try {
            ...
            Connection con = cp.getConnection();
            if (con != null) {
                String sql = "select * from product where color=? and id in(select product_id from product_r where cat_id in(select id from category where name=?)and weartype_id in(select id from wear_type where name=?))";
                PreparedStatement smt = con.prepareStatement(sql);
                smt.setString(1, color);
    ...
    public ArrayList<Product> getAllProductByWearTypeAndCategoryAndSize(String weartype, String category, String size) {
        ...
        try {
            ...
            Connection con = cp.getConnection();
            if (con != null) {
                String sql = "select * from product where size=? and id in(select product_id from product_r where cat_id in(select id from category where name=?)and weartype_id in(select id from wear_type where name=?))";
                PreparedStatement smt = con.prepareStatement(sql);
                smt.setString(1, size);
                smt.setString(2, category);
                smt.setString(3, weartype);
    ...
    public ArrayList<Product> getAllProductByWearTypeAndCategoryAndBrand(String weartype, String category, String brand) {
        ...
        try {
            ...
            Connection con = cp.getConnection();
            if (con != null) {
                String sql = "select * from product where brand=? and id in(select product_id from product_r where cat_id in(select id from category where name=?)and weartype_id in(select id from wear_type where name=?))";
                PreparedStatement smt = con.prepareStatement(sql);
                smt.setString(1, brand);
                smt.setString(2, category);
                smt.setString(3, weartype);
